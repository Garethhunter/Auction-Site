...
function updateBid() {
	...
	$.ajax({
		...
		dataType : "json",
		data : formToJSON(),
		success : function(data, textStatus, jqXHR) { console.log('bid updated successfully'); findAll();},
...
function deleteBid() {
	...
	$.ajax({
		type : 'DELETE',
		url : rootURL + 'bids/' + $('#bid_id').val(),
		success : function(data, textStatus, jqXHR) { console.log('bid deleted successfully');findAll();},
